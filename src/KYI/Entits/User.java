...
public class User {
    ...
    public User(int id, String name, String surname, String email, int workedHours, String password, int position, String profilePicture,String theme,boolean entry) {
        this.id = id;
        this.name = name;
